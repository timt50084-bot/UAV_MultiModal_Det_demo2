...
LEGACY_CONFIG_REDIRECTS = {
    ...
    'configs/exp_assigner_main.yaml': 'configs/archive/ablation/assigner_main.yaml',
    'configs/exp_baseline.yaml': 'configs/archive/ablation/baseline.yaml',
    ...
    'configs/exp_fusion_main.yaml': 'configs/archive/ablation/fusion_main.yaml',
    ...
    'configs/exp_temporal_main.yaml': 'configs/archive/ablation/temporal_main.yaml',
    'configs/exp_temporal_memory.yaml': 'configs/archive/ablation/temporal_memory.yaml',
    'configs/exp_tracking_assoc.yaml': 'configs/main/tracking_assoc.yaml',
    ...
    'configs/exp_tracking_jointlite.yaml': 'configs/main/tracking_jointlite.yaml',
    'configs/exp_tracking_modality.yaml': 'configs/main/tracking_modality.yaml',
    'configs/exp_tracking_temporal.yaml': 'configs/main/tracking_temporal.yaml',
    ...
    'configs/tracking/assoc.yaml': 'configs/main/tracking_assoc.yaml',
    ...
    'configs/tracking/jointlite.yaml': 'configs/main/tracking_jointlite.yaml',
    'configs/tracking/modality.yaml': 'configs/main/tracking_modality.yaml',
    'configs/tracking/temporal.yaml': 'configs/main/tracking_temporal.yaml',
}
