...
LEGACY_CONFIG_REDIRECTS = {
    'configs/exp_angle_aware_assigner.yaml': 'configs/ablation/angle_aware_assigner.yaml',
    'configs/exp_assigner_main.yaml': 'configs/ablation/assigner_main.yaml',
    'configs/exp_baseline.yaml': 'configs/ablation/baseline.yaml',
    'configs/exp_competition_infer.yaml': 'configs/infer/competition_infer.yaml',
    'configs/exp_error_analysis.yaml': 'configs/eval/error_analysis.yaml',
    'configs/exp_eval_full.yaml': 'configs/eval/full.yaml',
    'configs/exp_fusion_main.yaml': 'configs/ablation/fusion_main.yaml',
    'configs/exp_realistic_multimodal_aug.yaml': 'configs/ablation/realistic_multimodal_aug.yaml',
    'configs/exp_reliability_fusion.yaml': 'configs/ablation/reliability_fusion.yaml',
    'configs/exp_task_metrics.yaml': 'configs/eval/task_metrics.yaml',
    'configs/exp_temporal_main.yaml': 'configs/ablation/temporal_main.yaml',
    'configs/exp_temporal_memory.yaml': 'configs/ablation/temporal_memory.yaml',
    'configs/exp_tracking_assoc.yaml': 'configs/tracking/assoc.yaml',
    'configs/exp_tracking_base.yaml': 'configs/tracking/base.yaml',
    'configs/exp_tracking_eval.yaml': 'configs/tracking/eval.yaml',
    'configs/exp_tracking_final.yaml': 'configs/tracking/final.yaml',
    'configs/exp_tracking_jointlite.yaml': 'configs/tracking/jointlite.yaml',
    'configs/exp_tracking_modality.yaml': 'configs/tracking/modality.yaml',
    'configs/exp_tracking_temporal.yaml': 'configs/tracking/temporal.yaml',
}
